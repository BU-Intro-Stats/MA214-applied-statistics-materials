...
\begin{center}
 \Large Lecture 20 Notes: Posterior Inference
\end{center}
...
\concept{Everything is reading the posterior}
\concept{Credible intervals}
\concept{Bayesian hypothesis testing}
\concept{Model comparison}
\concept{Posterior prediction}
\concept{Predictive checking}
\end{document}
