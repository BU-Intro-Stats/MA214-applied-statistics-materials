...
\begin{center}
 \Large Lecture 8 Notes: Hypothesis Testing with Randomization
\end{center}
...
\concept{Why inference: from estimates to uncertainty}
\concept{Sampling vs.\ null distribution}
\concept{The hypothesis-testing procedure}
\concept{The p-value}
\concept{Decision errors (Type I, Type II, power)}
