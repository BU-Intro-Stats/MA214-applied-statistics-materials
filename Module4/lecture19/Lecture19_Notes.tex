...
\begin{center}
 \Large Lecture 19 Notes: MCMC and Diagnostics
\end{center}
...
\concept{Why approximate the posterior}
\concept{Grid approximation}
\concept{MCMC (Metropolis--Hastings)}
\concept{Tuning the step size}
\concept{Burn-in}
\concept{Diagnostics ($\widehat{R}$, ESS, MCSE, trace plots)}
\end{document}
