...
\begin{center}
 \Large Lecture 16 Notes: Logistic Regression Inference
\end{center}
...
\concept{The logistic model (linear in the log-odds)}
\concept{Inference for a coefficient}
\concept{Reading an odds ratio}
\concept{A confidence interval for a predicted probability}
\concept{Conditions}
\concept{Prediction: thresholds and proper scores}
\end{document}
