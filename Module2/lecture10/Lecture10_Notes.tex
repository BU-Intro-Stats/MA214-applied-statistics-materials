...
\begin{center}
 \Large Lecture 10 Notes: Inference with Mathematical Models
\end{center}
...
\concept{Conditions for using the CLT}
\concept{Formula-based confidence intervals and tests}
\concept{The $t$ distribution}
\concept{Two-sample and paired data}
\concept{Choosing between a formula and the bootstrap}
\end{document}
