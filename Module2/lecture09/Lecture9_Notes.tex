...
\begin{center}
 \Large Lecture 9 Notes: Confidence Intervals with Bootstrapping
\end{center}
...
\concept{From testing to estimation}
\concept{Parameter vs.\ statistic}
\concept{The bootstrap}
\concept{Two recipes for a confidence interval}
\concept{Interpreting a confidence interval}
\concept{Limits of the bootstrap}
\end{document}
