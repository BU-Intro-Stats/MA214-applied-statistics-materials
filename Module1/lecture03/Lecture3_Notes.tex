...
\begin{center}
 \Large Lecture 3 Notes: Linear Regression Models
\end{center}
...
\concept{Describing a scatterplot}
\concept{Simple linear regression model}
\concept{Interpreting the slope and intercept}
\concept{Residuals}
\concept{Least squares (and its MLE connection)}
\concept{Model assumptions (LINE)}
\end{document}
