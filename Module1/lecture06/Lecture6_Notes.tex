...
\begin{center}
 \Large Lecture 6 Notes: Logistic Regression
\end{center}
...
\concept{The logistic regression model}
\concept{Odds and log odds}
\concept{Coefficients as odds ratios}
\concept{Fitting by maximum likelihood}
\concept{Classification and thresholds}
\end{document}
