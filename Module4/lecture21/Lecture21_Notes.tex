...
\begin{center}
 \Large Lecture 21 Notes: Bayesian Linear Regression
\end{center}
...
\concept{The Bayesian regression model}
\concept{Choosing the priors}
\concept{Prior predictive check}
\concept{Posterior inference (credible intervals)}
\concept{Two prediction questions}
\concept{Bootstrap is not a posterior}
\end{document}
