...
\begin{center}
 \Large Lecture 14 Notes: Inference for Multiple Regression
\end{center}
...
\concept{Reading a coefficient row}
\concept{Every test is conditional on the other predictors}
\concept{Multicollinearity}
\concept{Transformations and their interpretation}
